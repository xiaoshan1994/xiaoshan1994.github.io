...
Cost-benefit integrated assessment models are the {{< hl-text red >}}main tools for calculating the social cost of carbon{{< /hl-text >}}, or the {{< hl-text red >}}marginal social cost of emitting one more tonne of carbon (as carbon dioxide) into the atmosphere at any point in time{{< /hl-text >}}.[28] For instance, the DICE,[29] PAGE,[30] and FUND[31] models have been used by the US Interagency Working Group to calculate the social cost of carbon and its results have been used for regulatory impact analysis.[32]
