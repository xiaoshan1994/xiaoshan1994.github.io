...
![image](https://user-images.githubusercontent.com/65668613/152815597-20605006-56e5-49ea-819f-7c7588bf9d1f.png)
 ...
 {{< alert danger >}}Confused equation as $DM_{ij}$ and $Exp_{ij}$ will also change under the two scenarios. The correct form should be \\(EIT_{ij}=(EIT_{DM_{ij}})+(EIT_{Exp_{ij}})+(EIT_{tran_{ij}})=-(EX'_{ij} \times DM'_{ij}-EX_{ij} \times DM_{ij})+(EX'_{ij} \times Exp'_{ij}-EX_{ij} \times Exp_{ij})+(EX'_{ij} \times tran'_{ij}-EX_{ij} \times tran_{ij})\\) {{< /alert >}}
