...
{{< alert info >}}Whether we can complement the treatment of "mismanaged"? As it makes an effect on the environment, such as end up with marine litter{{< /alert >}}

{{< alert info >}}Should the process of energy recovery by incineration be considered as a mitigation way of CO2? {{< /alert >}}
...
{{< alert info >}}Quite interesting to investigate the relationship between the plastic waste trade and global warming. Whether developed countries tend to have a higher incineration rate or a higher unit impact value on global warming? And the trade to some extent facilitates the mitigation of global warming?  {{< /alert >}}
...
* Countries with huge flow change account for huge impacts: Japan, the USA, Hong Kong, and Germany.
