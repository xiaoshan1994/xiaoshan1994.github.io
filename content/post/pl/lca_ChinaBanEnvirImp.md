 ...
 **Fig. 4: EIT and Eco-cost of the China ban for 2018 Scenario.**
 ...
 $$mathrm{DM}}}} \right)_{ij} + \left( {EIT_{{\mathrm{Exp}}}} \right)_{ij} + \left( {EIT_{{\mathrm{tran}}}} \right)_{ij}\\ 	= \left( {EX^\prime _{ij} - EX_{ij}} \right)\left( { - DM_{ij} + Exp_{ij} + tran_{ij}} \right)$$
