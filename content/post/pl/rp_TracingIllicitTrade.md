...
| United States | Malaysia | Hong Kong | There is no official comprehensive US data recording the new destinations of US plastic waste following the introduction of the Chinese ban.72 However, the state of California accounts for nearly a third of all US exports to non-OECD countries and this is the main origin of illicit waste into {{< hl-text orange>}}Malaysia (which became number one destination after the introduction of the import ban in China).{{< /hl-text >}}|
| United States | Thailand |  | {{< hl-text orange>}}Thailand saw the largest increase of imports immediately following the introduction of China’s import ban.{{< /hl-text >}} 90% of plastics transit through the deep-water port of Laem Chabang. |
| United States   | The Philippines  | | In the post-National Sword era, {{< hl-text orange>}}exports to the Philippines grew exponentially{{< /hl-text >}}, especially from Japan and the US.|
...
| North America, Europe | Pakistan |           | {{< hl-text orange>}}{{< hl-text blue>}}Pakistan{{< /hl-text >}} is a net importer as local plastic production is limited to meeting national demand.{{< /hl-text >}} It has become common for shipments to South East Asian countries to be redirected to Pakistan. |
...
| Germany | Turkey | {{< hl-text blue>}}Belgium{{< /hl-text >}} | As of June 2021, over 100 illicit containers that had reached Turkey from Germany via the port of Antwerp were sitting in Turkey waiting to be sent back to Germany. They contained mixed waste contaminated with household waste.  |
| Italy | Malaysia |    | The {{< hl-text blue>}}Italy–Kuala Lumpur (/ˌkwɑːləˈlʊmpʊə吉隆坡)route{{< /hl-text >}} is believed to be a significant route for illegal shipping of waste. Companies are believed to rely on Hong Kong-based agents who would, on paper, broker shipments to Hong Kong when, in reality, illegal plastic waste would arrive directly in Malaysia. |
| Italy | Tunisia |   | Italy’s Campania region has been identified as the point of origin of hundreds of containers full of mixed municipal waste that were directed to the Port of Sousse in {{< hl-text blue>}}Tunisia{{< /hl-text >}} in 2020.8  |
...
| United Kingdom | Malaysia | Turkey | {{< hl-text orange>}}{{< hl-text blue>}}Turkey (39%){{< /hl-text >}} and {{< hl-text blue>}}Malaysia (12%){{< /hl-text >}} are the top two destinations for illicit plastic waste from the UK.{{< /hl-text >}} Both have limited capacity to recycle, and illegal dumping and burning are widespread.|
| United Kingdom | Malaysia  | {{< hl-text blue>}}The Netherlands{{< /hl-text >}} | UK-origin plastic waste is sent for recycling to the Netherlands, where it is instead mixed with Dutch waste and then shipped to countries that no longer accept British plastic. {{< hl-text orange>}}As of 2021, evidence shows continued shipping from Dutch ports to non-OECD countries.{{< /hl-text >}} |
| United Kingdom | Poland  |     | {{< hl-text orange>}}{{< hl-text blue>}}Poland{{< /hl-text >}} is the third-largest recipient of illicit plastic waste from the UK.{{< /hl-text >}} |
...
| United Kingdom | Turkey |    | The {{< hl-text blue>}}Cilicia region of {{< /hl-text >}}, from the Mediterranean to the Syrian border, is the main entry point for plastic waste and a highly polluted area. |
...
| South Africa | Portugal, Italy, Malaysia, Hong Kong and Pakistan |      | {{< hl-text orange>}}South Africa is both an importer and exporter of illegal plastic waste.{{< /hl-text >}} Multiple shipments to international destinations have been recorded in 2020 and 2021.|
| Japan, Singapore | Malaysia |        | Malaysia has repatriated illegal waste back to Spain, Japan and  Singapore. |
| Japan | The Philippines  |  | {{< hl-text orange>}}Japan has a history of shipping toxic and hazardous waste to the Philippines{{< /hl-text >}}, but Tokyo’s repatriation of waste containers has won it praise from the Filipino government.  |
