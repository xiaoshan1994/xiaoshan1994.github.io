...
Now not only the flow 'used engine' but also the flow 'aluminium
scrap' is negatively valued and is thus a waste flow
which should be traced down to its waste management process,
