...
Therefore, the indirect Scope 2 emissions of one unit of the final output for sector i in country s are $\color{blue} f^sl_i = f^sD * \sum_r a^sr_iD35E36$, where $f^sd$, $f^sd_D$ represents the direct emissions from one unit of total output of the energy sector in the exporting country, $a_aD$ is the direct consumption coefficient of sector 𝑖
